...
- 카메라 중앙 Line Trace로 목표점을 찾고, 유물 위치에서 목표점에 도달하는 중력 탄도를 계산합니다. `Forward Speed`와 `Upward Speed`는 탄도 계산의 전체 속력에 함께 반영됩니다.
- 바닥이나 벽이 첫 충돌이어도 캐릭터 공격 판정은 유지되며, 캐릭터 넉백 성공·재잡기·최대 비행 시간 만료 시 종료됩니다.
